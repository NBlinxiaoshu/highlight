...
4. 在配置页填写所需 API Key。
5. 打开支持的内容页面，点击「小黄笔」或页面右下角的「精读这期」。
...
阅读过程中可以把原文片段一键加入笔记，并保留来源与时间戳。

<p align="center"><img src="assets/shot-06-notes.png" alt="笔记视图" width="72%" /></p>

支持导出 TXT / Markdown / Word / 网页 / PDF，方便继续整理到自己的知识库。
...
<p align="center"><img src="assets/shot-08-history.png" alt="历史记录" width="72%" /></p>
...
<p align="center"><img src="assets/todo_1.png" alt="自动跟进固定的信息源" width="72%" /></p>
...
<p align="center"><img src="assets/todo_2.png" alt="用真实标注结果调整高亮" width="72%" /></p>
